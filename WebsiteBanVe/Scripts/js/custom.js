...
function init_BookingTwo () {
    ...
    //3. Choose sits (and count price for them)
                ...
                var selectedSeatsInput = $('#selectedSeats');
                var totalTicketPriceInput = $('#totalTicketPrice');
                $('.sits__place').click(function (e) {
                    ...
                    if(! $(e.target).hasClass('sits-state--your')){
                        ...
                        if (! $(this).hasClass('sits-state--not') ) {
                            ...
                            selectedSeatsInput.val(selectedSeatsInput.val() + ' ' + place);
                        ...
                        $('.' + place + '').remove();
                        selectedSeatsInput.val(selectedSeatsInput.val().replace(' ' + place, '').replace(place + ' ', '').replace(place, ''));
